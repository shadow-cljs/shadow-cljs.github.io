...
https://github.com/thheller/shadow-cljs/wiki/ClojureScript-for-node.js-scripts[Compiling node.js scripts].

== Node Libraries (`:target :node-library`)

// TODO:

https://github.com/thheller/shadow-cljs/wiki/ClojureScript-for-node.js-libraries[Compiling node.js libraries].
